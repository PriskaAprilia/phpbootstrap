        ...
        <div class="row justify-content-center">
            <div class="col-md-12">
                <div class="card border-primary">
                    ...
                    <div class="card-body">
                    <form action="tugasutspembayaran.php" method="post">
                        <?php
                        ...
                        <div class="table-responsive">
                            <table class="table">
                                ...
                                <tr>
                                    ...
                                    <td colspan="3"><?php $originalDate = $tanggalbeli;
                                    echo $newDate = date("d M Y", strtotime($originalDate)); ?></td>
                                </tr>
                                <tr>
                                    <td colspan="6" align="center"><b>Lipmate yang dipilih/b></td>
                                </tr>
                                <tr>
                                    <th>Nomor</th>
                                    <th>Nama lipmate</th>
                                ...
                                <tr>
                                    <td colspan="6">
                                        <input type="hidden" name="anya" id ="anya" value="<?php echo $total; ?>">
